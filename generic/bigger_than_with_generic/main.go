...
func isGreatThan[T Ordererable](v1, v2 T) bool {
	if v1.Order(v2) > 0 {
		return true
	}
	return false
...
func main() {
	...
	fmt.Printf("is shape1 greather than shape3: %v\n", isGreatThan(shape1, shape3))
	fmt.Printf("is shape1 greather than si1: %v\n", isGreatThan(shape1, si1)) // err catch at the compilation
}
